package com.rahuls.elastic.load;

import com.rahuls.elastic.jparepository.UserJpaRepository;
...
public class Loaders {
	...
	public void loadAll(){
		...
		operations.putMapping(Users.class); // creating of index - can also create using elasticTemplate
	...
	// Sample data to load/save
	private List<Users> getData() {
        List<Users> userses = new ArrayList<>();
        userses.add(new Users("Rah",123L, "Accounting", 12000L));
